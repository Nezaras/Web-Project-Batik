...
const stepData = {
  0: [
    { title: "Warna Jilbab", colors: ['#243565', '#aa5c9e', '#ce433b', '#80cde9', '#eabcd4', '#1d1c1d', '#d86f3a', '#FFFFFF', '#bf996a', '#9bc654'] }
  ],
...
function getBodyBounds() {
  return { minX: 60, maxX: 300, minY: 10, maxY: 200 };
}
...
function enableMotifDrag(motif, container) {
  ...
  document.addEventListener('pointermove', (e) => {
    ...
    const corners = [ [svgX, svgY], [svgX2, svgY], [svgX, svgY2], [svgX2, svgY2] ];
